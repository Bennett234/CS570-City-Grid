...
public abstract class Car {
    ...
    public void draw(PApplet applet, City city, float animationState) {
        ...
        drawCar(applet, (x + 0.25f) * city.grid.size, (y + 0.25f) * city.grid.size, city.grid.size * 0.5f, city.grid.size * 0.5f);
    }
    
    public abstract void drawCar(PApplet applet, float x, float y, float w, float h);
